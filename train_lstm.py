...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 19 16:16:18 2017
...
def train_neural_network():  
    ...
    with tf.Session() as sess:  
        ...
        for epoch in range(50):  
            ...
            n = 0
            if epoch % 7 == 0:
                saver.save(sess, './module/poetry.module', global_step=epoch)
            for batche in range(n_chunk):  
                train_loss, _ , _ = sess.run([cost, last_state, train_op], feed_dict={input_data: x_batches[n], output_targets: y_batches[n]})  
                n += 1  
                print(epoch, batche, train_loss)
            if epoch % 7 == 0:
                saver.save(sess, 'D:/Python_code/Emotion_analysis/RNN生成古诗词/module/', global_step=epoch)
